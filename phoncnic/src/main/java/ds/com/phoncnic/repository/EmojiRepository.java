...
public interface EmojiRepository extends JpaRepository<Emoji, Long> {
    ...
    // @Query("select e, count(e) from Emoji e where e.gallery.gno=:gno group by
    // e.gallery.gno ")
    // List<Emoji> getCountEmoji(Long gno);

    // @Query("select e, count(e) from Emoji e where
    // e.emojiinfo.emojitype=:emojitype group by e.gallery.gno ")
    ...
    static List<Object[]> getEmojiCountByGno(Long gno) {
