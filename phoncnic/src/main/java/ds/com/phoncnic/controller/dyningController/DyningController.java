...
public class DyningController {
    ...
    public void cafeList(Model model,@AuthenticationPrincipal AuthMemberDTO dto) {
        ...
        try {
            ...
            model.addAttribute("hairDTO", characterLookService.getCharacterSet(dto.getId()));
        } catch (NullPointerException e) {
            model.addAttribute("id","");
            model.addAttribute("hairDTO", characterLookService.getCharacterSet("user10@icloud.com"));
        }
